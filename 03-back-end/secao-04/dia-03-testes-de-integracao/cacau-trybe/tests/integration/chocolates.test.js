...
describe('Usando o método GET em /chocolates', function () {
  ...
  describe('Usando o método GET em /chocolates/total para buscar o total de chocolates', function () {
    it('Retorna um total de 4', async function () {
  ...
  describe('Usando o método GET em /chocolates/search para buscar chocolates com uma determinada palavra em seu nome', function () {
    it('Retorna os chocolates Mon Chéri e Mounds ao pesquisar usando o termo "Mo"', async function () {
  ...
  describe('Usando PUT em /chocolates/:id para atualizar as informações de um chocolate', function () {
    it('Caso o chocolate exista, atualiza as infos corretamente', async function () {
